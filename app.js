...
app.get("/blogs", function(req, res) {
    Blog.find({}, function(err, blogs) {
        ...
        console.log(blogs);
        res.render("blogs", { content: blogs });
    });
});

app.get("/blogs/:blogTitle", function(req, res) {
    blogT = _.lowerCase(req.params.blogTitle);
    Blog.find({ title: blogT }, function(err, selectedBlog) {
        if (err) {
            console.log(err);
        }
...
app.post("/compose", function(req, res) {
    const newBlog = new Blog({
        ...
        post: req.body.newComposePost
    });
    Blog.insertMany(newBlog, function(err) {
        if (err) {
            console.log(err);
        }
    });
